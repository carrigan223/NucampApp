...
export const postComment = (campsitesId, rating, text, author) => (
  dispatch
) => {
  const newComment = {
    campsiteId: campsitesId,
    rating: rating,
    author: author,
    text: text,
  };
...
// begin with fetch partners(THUNK) action then also an loading failed and add
